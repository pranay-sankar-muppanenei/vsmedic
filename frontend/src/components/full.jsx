  ...
  const cards = [
    {
      ...
      image:
        "/visit.jpg", // replace with real image
    },
    {
        ...
        {cards.map((card, idx) => (
          ...
          >
            ...
            <div className="absolute inset-0 backdrop-blur-xs   bg-opacity-50 flex flex-col items-center justify-center text-center px-6">
              ...
              <button
                className="mt-6 bg-white text-indigo-600 font-semibold py-2 px-6 rounded-full border border-transparent
                           hover:border-indigo-600 hover:shadow-lg hover:shadow-indigo-200 transition-all"
              >
                {card.buttonText}
              </button>
            </div>
