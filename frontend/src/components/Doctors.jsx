...
const Doctors = () => {
  ...
  return (
    <div className="bg-[#f8f8ff] min-h-screen py-12 px-4">
      {/* Stats Section */}
      <h1 className="text-center text-[#4B771E] text-3xl font-bold mb-6 tracking-wide">Our Doctors</h1>
      ...
      >
        {statsData.map((stat, i) => (
          <div
            key={i}
            className={`p-6 rounded-lg border border-gray-200 text-center shadow-sm transition-transform duration-300 hover:scale-105 hover:border-[#4B771E] hover:shadow-lg hover:shadow-green-200 ${
              stat.highlight
