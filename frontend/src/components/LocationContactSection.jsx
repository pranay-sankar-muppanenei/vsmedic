      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <a
              href="#"
              className="flex items-center gap-2 bg-indigo-600 text-white px-4 py-2 rounded-full hover:bg-green-600 transition"
            >
              <FaWhatsapp /> WhatsApp Us Now
            </a>
            <a
              href="tel:+919876543210"
              className="flex items-center gap-2 bg-gray-200 text-black px-4 py-2 rounded-full hover:bg-indigo-700 transition"
            >
