  ...
  return (
    <section className="bg-[#f9f9ff] py-16">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        {/* Testimonial Card */}
        <div className="mt-12 bg-white rounded-xl shadow-lg p-6 flex flex-col md:flex-row items-center gap-8">
          {/* Media */}
        ...
        {/* CTA */}
        <button className="mt-8 px-6 py-3 bg-indigo-600 text-white rounded-full shadow-md hover:bg-indigo-700 transition">
